...
-- the average total duration of assistance requests for each cohort
...
-- each assignment with the total number of assistance requests with it.
...
--  the same query as before, but include the number of assistances as well
